...
//        
//        // Execute it
//        log.debug("[DataPool > InventoryRegion] Loading page \(page), got \(previousItems.count) items so far...")
//        return Request2.post(endpoint: "/vatom/discover", payload: filter.getPayload()).then { data -> Promise<[String]?> in
//            
...
//                    log.warning("[DataPool > InventoryRegion] Couldn't process incoming vatom")
//                    return
//                }
//                
//                // Notify incoming
...
//            log.warning("[DataPool > BVWebSocketRegion] Logic error in WebSocket message, old_owner and new_owner shouldn't be the same: \(vatomID)")
//            
//        }
//        
//    }
