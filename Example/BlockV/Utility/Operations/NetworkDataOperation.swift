...
class NetworkDataOperation: AsynchronousOperation {
    ...
    private var networkOperationCompletionHandler: ((_ responseData: Data?, _ error: Error?) -> Void)?
    ...
    init(urlString: String, networkOperationCompletionHandler: ((_ responseData: Data?, _ error: Error?) -> Void)? = nil) {
    ...
    override func main() {
        request = Alamofire.request(urlString, method: .get)
            .responseData { dataResponse in
                ...
                self.networkOperationCompletionHandler?(dataResponse.data, dataResponse.result.error)
